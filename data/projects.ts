export const projects = [
  ...
  {
    title: "Nimu",
    description: "Reputation-first AI outreach platform with automated domain authentication, multi-step drip campaigns, mailbox warm-up, and real-time deliverability monitoring.",
    github: null,
    demo: "https://nimu.app",
    technologies: ["Next.Js", "NestJs", "PostgreSQL", "Docker", "AWS","Tailwind CSS"],
